      ...
      >
        <div className="container">
          <div className="section-heading">
            ...
            <p>
              يمكن أن تختلف طريقة التعامل
              مع العطل بحسب مكان المشكلة
              وطبيعة الأعراض وحالة النقطة
              أو المكوّن الكهربائي المرتبط
              بها.
            </p>
          </div>
          ...
          <div className="container">
            <div className="section-heading">
              ...
              <h2 id="service-faq-heading">
                أسئلة شائعة حول إصلاح الأعطال الكهربائية
              </h2>
            </div>
        ...
        >
          <div className="container">
            <div className="section-heading">
              ...
              <p>
                قد يرتبط إصلاح الأعطال
                بأعمال التمديدات أو
                الإنارة أو التشطيب
                الكهربائي بحسب طبيعة
                المشكلة.
              </p>
            </div>
